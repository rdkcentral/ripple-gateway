...
use crate::{
    api::{
        ...
        firebolt::{
            ...
            fb_player::{
                PlayerRequestWithContext, PlayerResponse, StreamingPlayerRequestWithContext,
            },
...
pub enum ExtnRequest {
    ...
    Player(PlayerRequestWithContext),
    StreamingPlayer(StreamingPlayerRequestWithContext),
...
pub enum ExtnResponse {
    ...
    // StreamingPlayer(PlayerResponse),
